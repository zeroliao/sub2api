    ...
    alertRules: {
      ...
      metricDescriptions: {
        ...
        accountTempUnscheduledCount:
          "当前处于临时不可调度状态的账号数量（如代理/凭据故障被自动摘除）。",
