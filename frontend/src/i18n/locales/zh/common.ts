export default {
  common: {
    ...
    peakRateImageNote:
      "；token 计费的图片 token 同样适用，图片按次计费不受高峰影响",
    save: "保存",
    saved: "保存成功",
    deleted: "删除成功",
    cancel: "取消",
  ...
  adminCompliance: {
    ...
    riskNotice:
      "本确认用于以清晰、显著、可留痕的方式提示自部署实例的合规义务与运营风险。",
    version: "协议版本",
  ...
  auth: {
    ...
    dingtalk: {
      ...
      backToLogin: "返回登录",
      invitationRequired:
        "该钉钉账号尚未注册，站点已开启邀请码注册，请输入邀请码以完成注册。",
