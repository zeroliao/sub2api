export default {
  accounts: {
    ...
    upstreamBilling: {
      ...
      autoProbeHint:
        "Probe this account's upstream declared rate on the global interval when global probing is enabled.",
    ...
    fillRecommendedModels: "Fill recommended models",
    fetchAPIKeyModels: "Fetch models for this key",
    apiKeyRequiredForModelSync:
      "Enter the API key before fetching available models",
    failedToFetchAPIKeyModels: "Failed to fetch available models",
    noAPIKeyModelsReturned: "Upstream returned no available models",
    apiKeyModelsSynced: "Fetched {count} available model(s)",
