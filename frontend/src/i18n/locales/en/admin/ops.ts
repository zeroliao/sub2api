export default {
  ops: {
    ...
    systemLogs: {
      title: "System Logs",
      description:
        "Newest logs are shown first. Filter, search, and clean up by condition.",
      queue: "Queue",
      written: "Written",
      dropped: "Dropped",
      failed: "Failed",
      ...
      resetRuntimeConfigConfirm:
        "Reset to startup configuration (env/yaml) and apply immediately?",
      runtimeConfigReset: "Reset to startup log configuration",
      runtimeConfigResetFailed: "Failed to reset log configuration",
      cleanupConfirm:
        "Clean up system logs matching the current filters? This cannot be undone.",
      cleanupSuccess: "Cleanup complete. Deleted {count} log entries.",
      cleanupFilterRequired:
        "Cleanup requires at least one filter condition (start/end time or another field)",
    ...
    errorDetail: {
      ...
      suggestUpstream:
        "Upstream instability: check account status or consider switching accounts",
      suggestRequest:
    ...
    settings: {
      ...
      openaiQuotaAutoPauseHint:
        "When an OpenAI account reaches its 5h / 7d usage threshold, the scheduler skips it automatically and resumes once the window rolls over. Per-account thresholds take precedence over this global default.",
      openaiQuotaAutoPauseDefault5h: "Default 5h usage threshold (%)",
      openaiQuotaAutoPauseDefault7d: "Default 7d usage threshold (%)",
      openaiQuotaAutoPauseThresholdHint:
        "Value 0-100; leave blank or 0 to disable the global default threshold.",
      ...
      validation: {
        ...
        upstreamErrorRateMaxRange:
          "Upstream error rate maximum must be between 0 and 100",
        openaiQuotaAutoPauseRange:
          "OpenAI quota auto-pause threshold must be between 0 and 100",
      },
    },
    concurrency: {
    ...
    tooltips: {
      ...
      errorDistribution:
        "Error distribution by status code (SLA scope, excluding business limits).",
      goroutines:
