...
```powershell
git clone git@github.com:zeroliao/zero007-sub2api-ops.git C:\Users\Administrator\Desktop\code\sub2api
git clone git@github.com:zeroliao/sub2api.git C:\Users\Administrator\Desktop\code\sub2api-src
```

如果 SSH key 不是默认 key，为两个仓库绑定专用 key：

```powershell
git -C C:\Users\Administrator\Desktop\code\sub2api config core.sshCommand "ssh -i C:/Users/Administrator/.ssh/codex_new_pc -o IdentitiesOnly=yes -o StrictHostKeyChecking=accept-new"

git -C C:\Users\Administrator\Desktop\code\sub2api-src config core.sshCommand "ssh -i C:/Users/Administrator/.ssh/codex_new_pc -o IdentitiesOnly=yes -o StrictHostKeyChecking=accept-new"
```
...
```text
C:\Users\Administrator\Desktop\code\sub2api\.env.ops
```
...
```powershell
cd C:\Users\Administrator\Desktop\code\sub2api
